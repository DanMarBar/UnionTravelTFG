...
const REDIRECT_URI = 'https://10da-66-81-168-49.ngrok-free.app/authenticate';
...
export const githubAuth = async (req, res) => {
    ...
    try {
        ...
        const redirectUrl = `exp://192.168.1.129:8081/--/auth?userInfo=${encodeURIComponent(JSON.stringify(userInfo))}`;
        console.log('Redirecting to:', redirectUrl); // Imprime la URL de redirección

        // Redirige a la app de React Native Expo con la información del usuario
